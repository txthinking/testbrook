...
deno compile -A -r --unstable --target x86_64-pc-windows-msvc -o _/testbrook_windows_amd64.exe https://raw.githubusercontent.com/txthinking/testbrook/master/testbrook.js
